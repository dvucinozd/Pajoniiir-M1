...
> **SUPERSEDED DISPLAY FORENSICS.** This document concerns the retired 30-pin JC4880 path. The active board exposes a generic 15-pin DSI host, summarized in `Pajoniiir_M1_Current_Design_Status_B8.md`.
