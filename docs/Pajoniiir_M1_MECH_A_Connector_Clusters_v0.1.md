...
> **HISTORICAL SCREENING RECORD.** This display-derived wall mapping is no longer active board authority. Use `Pajoniiir_M1_Current_Design_Status_B8.md` for current status.
