...
> **HISTORICAL SELECTION RECORD.** J1 is now locked to Switchcraft 722RAHLP, while its PCB land pattern remains open pending terminal-center evidence. See `Pajoniiir_M1_Current_Design_Status_B8.md`.
