...
The project geometry was normalized against the official Espressif `ESP32-P4X` pin map and is maintained under KiCad 10:

- https://github.com/espressif/kicad-libraries
- official symbol: `ESP32-P4X`
- required M1 MPN: `ESP32-P4NRW32X`

All 105 physical pin numbers, names and electrical types are programmatically matched to the official symbol. The local copy is retained as the reviewed, version-pinned project symbol; all future library synchronization and validation uses KiCad 10.

## ESP32-P4 footprint

`footprints.pretty/ESP32-P4.kicad_mod` is the reviewed project copy of the official Espressif footprint from the same upstream library and is maintained with KiCad 10.

Verify upstream package drawing again before fabrication.

## TPS259474 / RPW0010A footprint

`footprints.pretty/Texas_RPW0010A_VQFN-HR-10_2x2mm.kicad_mod` is the project-local KiCad 10 land pattern for `TPS259474ARPWR`.
