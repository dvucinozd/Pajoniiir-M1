...
FINAL_DISPLAY = BASE / "display_compatibility_dsi506.json"
...
def converge_mech(mech: dict, display: dict, blockers: list[str]) -> None:
    ...
    mech["authoritative_display_reference"] = {
        ...
        "authority": "display_compatibility_dsi506.json + display_connector_b1.json; supersedes JC4880/Guition for final-product mechanics",
...
def converge_gates(gates: dict) -> list[str]:
    ...
    j6.update({
        ...
        "evidence_file": "display_connector_b1.json + display_compatibility_dsi506.json + mech_a.json",
        ...
        "resolved_evidence": [
            ...
            },
            {
                ...
                "authority": "display_compatibility_dsi506.json",
            },
        ],
    ...
    outline["known_evidence"] = [
        "final DSI506 rear PCB preliminary envelope = 121.109 x 77.93 mm",
    ...
    outline["evidence_file"] = "display_compatibility_dsi506.json + mech_a.json"
...
def converge_pcb_constraints(pcb: dict, display: dict) -> None:
    ...
    pcb["mechanical_reference"] = {
        "authority": "mech_a.json + display_compatibility_dsi506.json",
...
def prepend_legacy_notice() -> None:
    ...
    notice = """> **SUPERSEDED FOR FINAL-PRODUCT DISPLAY MECHANICS — M1-MECH-A13 / M1-ELEC-B2 (2026-09-04)**\n> The JC4880/Guition geometry below is retained only as historical enclosure evidence. The final M1 display is EYOYO DSI506 / DYL0023, and its 121.109 × 77.93 mm preliminary rear-PCB evidence makes the old enclosure a hard fail. Do not derive final Edge.Cuts, mounting or Z clearances from this document. Current authority: `display_compatibility_dsi506.json`, `display_connector_b1.json`, `mech_a.json`.\n\n"""
